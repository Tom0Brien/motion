...
namespace motion {
    ...
    /**
     * @brief Manually convert the given rotation matrix to [Roll, Pitch, Yaw] ZYX
     * intrinsic euler angle (Better range than Eigen conversion).
    ...
    /**
     * @brief Convert given Euler angles in [Roll, Pitch, Yaw] ZYX intrinsic format
     * to rotation matrix
    ...
    /**
     * @brief Computes the 6x6 cross-product matrix for a motion vector and a force
     * vector.
